...
const i18n = new I18n({
  en: {
    ...
    home: {
      ...
      notLoggedForDay: 'You didn\'t log an outfit for this day',
      logForDay: 'Log outfit',
      seeAll: 'See All',
      ...
      suggestionGarments: 'Garments',
      suggestionReasoning: 'Why this suggestion',
      suggestionDescription: 'Description',
      saveSuggestion: 'Save Outfit',
      saved: 'Saved',
      editSuggestion: 'Edit',
    ...
    garments: {
      create: {
        ...
        incompleteMessage: 'Please complete all required fields (Name, Photo, Brand, Color, Season, and Style) to add the garment to the closet.',
    ...
    outfits: {
      ...
      deleteWarning: 'This action CANNOT be undone. Are you sure you want to permanently delete "{{name}}" and all its history?',
      ...
      create: {
        ...
        styleSelectionTitle: 'Select Style',
        styleSelectionSubtitle: 'Choose 1 or 2 styles for the random outfit',
        styleSelectionPick: 'Pick up to 2 styles',
        styleSelectionGenerate: 'Generate',
        styleFormal: 'Formal',
        styleCasual: 'Casual',
        styleDeportivo: 'Sporty',
        styleElegante: 'Elegant',
        styleBohemio: 'Bohemian',
        styleUrbano: 'Urban',
        mixSectionTitle: 'AI Mixed Outfit',
        mixSelectHint: 'Select 1-2 base garments and let AI complete the outfit',
        mixButton: 'Complete with AI',
        mixLoading: 'AI is generating...',
        mixError: 'Could not generate the outfit. Please try again.',
        mixAccept: 'Accept Suggestion',
        mixRetry: 'Retry',
        mixClear: 'Clear',
        mixMaxReached: 'Maximum 2 base garments',
    ...
    selectDateForLog: 'Select a day to log this outfit',
  ...
  es: {
    ...
    auth: {
      ...
      invalidResetLink: 'Este link de restablecimiento no es válido o expiró. Pedí uno nuevo.',
      backToLogin: 'Volver al inicio de sesión',
      resetLinkExpired: 'Link expirado',
    ...
    home: {
      ...
      notLoggedForDay: 'No registraste un outfit para este día',
      logForDay: 'Registrar outfit',
      seeAll: 'Ver Todo',
      ...
      suggestionGarments: 'Prendas',
      suggestionReasoning: 'Por qué esta sugerencia',
      suggestionDescription: 'Descripción',
      saveSuggestion: 'Guardar Outfit',
      saved: 'Guardado',
    ...
    garments: {
      create: {
        ...
        incompleteMessage: 'Por favor completa todos los campos obligatorios (Nombre, Foto, Marca, Color, Temporada y Estilo) para agregar la prenda al closet.',
    ...
    outfits: {
      ...
      removedFavorite: 'Quitado de favoritos',
      ...
      deleteWarning: 'Esta acción NO se puede deshacer. ¿Estás seguro de que querés eliminar permanentemente "{{name}}" y todo su historial?',
      ...
      create: {
        ...
        styleSelectionTitle: 'Elegí estilo',
        styleSelectionSubtitle: 'Elegí 1 o 2 estilos para el outfit aleatorio',
        styleSelectionPick: 'Seleccioná hasta 2 estilos',
        styleSelectionGenerate: 'Generar',
        styleFormal: 'Formal',
        styleCasual: 'Casual',
        styleDeportivo: 'Deportivo',
        styleElegante: 'Elegante',
        styleBohemio: 'Bohemio',
        styleUrbano: 'Urbano',
        mixSectionTitle: 'Outfit Mixto IA',
        mixSelectHint: 'Seleccioná 1-2 prendas como base y la IA completa el outfit',
        mixButton: 'Completar con IA',
        mixLoading: 'La IA está generando...',
        mixError: 'No se pudo generar el outfit. Intentá de nuevo.',
        mixAccept: 'Aceptar sugerencia',
        mixRetry: 'Reintentar',
        mixClear: 'Limpiar',
        mixMaxReached: 'Máximo 2 prendas base',
    ...
    selectDateForLog: 'Seleccioná un día para registrar este outfit',
